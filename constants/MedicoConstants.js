const MedicoConstants = {
    MATRICULA_YA_EXISTENTE: "Ocurrio un error! La matricula que ingresaste ya está registrado por otro medico",
    DNI_YA_EXISTENTE: "Ocurrio un error! El documento que ingresaste ya está registrado por otro medico",
